...
initial_timer = threading.Timer(getSecondsToTime(8, 5, 1), autoUpdateEveryDay, (searcher, citation, conf))
...
st.set_page_config(
     ...
     menu_items={
         ...
         "Report a bug": "https://github.com/QGrain/Scholar-Watcher/issues",
